...
public class FunWithOop {
	public static void main(String[] args) {
		...
		//static variables maxLives
		System.out.println(c2.maxLives);//field should be accessed in a static way
		c2.maxLives = 10;
		
		System.out.println(c1.maxLives);//it changed for all the cats!
		...
		((Animal) c1).makeNoise(); //this will still give the Cat verion of makeNoise()
