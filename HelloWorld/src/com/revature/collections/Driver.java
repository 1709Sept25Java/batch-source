...
public class Driver {
	...
	public static void funWithLists() {
		...
		Movie m2 = new Movie("","The Fast and the Furios",2001,"action");
		...
		//print out list of elements using instanceof
	...
	public static void funWithMaps() {
		//create a new HashMap with key-value pairs
		 ...
		 //no duplicate keys, the previous value for that key will be replaced
