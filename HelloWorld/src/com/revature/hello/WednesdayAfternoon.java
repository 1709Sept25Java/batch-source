...
public class WednesdayAfternoon {
	...
	public static void funWithStrings(){
		...
		//to split
		String str5= "java-split-string-method";
		...
		str8 = str8.concat("The world of string");
	...
	public static void funWithArrays() {
		...
		int intArray1D3[] = new int[7]; //this is correct by horrible 
		...
		System.out.println(intArray1D[2]);
		
		//Array utility class also has a sort, search, etc...documentation is your friend
	}
}
