...
CREATE OR REPLACE PROCEDURE UPDATE_USER (U_ID IN NUMBER, ADM_RIGHT IN VARCHAR2, FOUND OUT INTEGER)
IS
BEGIN
...
CREATE OR REPLACE PROCEDURE DELTE_ACCOUNT (U_ID IN INTEGER, BA_ID IN INTEGER, PASS OUT INTEGER)
IS
BEGIN
