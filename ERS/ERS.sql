...
BEGIN
    SET TRANSACTION ISOLATION LEVEL SERIALIZABLE; 
        ...
        VALUES (R_AMT, R_DESC, DEFAULT, R_AUTH, R_TYPE, 7007);
        S:=1;
    COMMIT;
    S:=0;
    EXCEPTION
...
CREATE OR REPLACE PROCEDURE SUBMIT_IMAGE(R_RECEI IN BLOB)
IS 
BEGIN
    SET TRANSACTION ISOLATION LEVEL SERIALIZABLE; 
        INSERT INTO REIMBURSEMENTS(R_AMOUNT, R_RECEIPT, R_SUBMITTED, U_ID_AUTHOR, RT_TYPE, RT_STATUS)
        VALUES (10, R_RECEI, DEFAULT, 3000, 9000, 7007);
    COMMIT;
    EXCEPTION
    WHEN OTHERS THEN ROLLBACK;
END;
