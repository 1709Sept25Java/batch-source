...
(TRANSACTION_DATE, BANK_ACCOUNT_ID, TRANSACTION_INFO) 
VALUES(CURRENT_DATE, 106, 'TEST');
...
(U_NAME IN VARCHAR2, U_PW IN VARCHAR2)
IS
UN_EXISTS INTEGER;
BEGIN
...
BEGIN
    ...
    IF BAL_VAL >= AMT THEN
        ...
        DBMS_OUTPUT.PUT_LINE(TRANS_INFO);
        ADD_TRANSACTION(ACC_ID, TRANS_INFO);
    ELSE
...
BEGIN
    SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
    INSERT INTO TRANSACTIONS(BANK_ACCOUNT_ID, TRANSACTION_INFO)
    VALUES(BANK_ACC_ID, TRANS);
