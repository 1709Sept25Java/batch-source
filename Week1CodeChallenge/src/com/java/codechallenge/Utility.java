...
package com.java.codechallenge;

public abstract class Utility {
	
	protected static String start = "ACGTTAAG";
	protected static String end = "ACGTTAAC";
	protected static String[] bank = {"ACGTTAAC", "ACGTTAAC", "ACGTTAAC"};
...
The starting and ending sequences and mutation bank may be (in descending order of points awarded) read from a file, input through the console,
