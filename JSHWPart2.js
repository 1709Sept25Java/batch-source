//  1
function getUSA() {
	var usa = document.querySelectorAll("span");
...
function getPeopleInSales() {
	var emp = document.querySelectorAll("td.empName");
	console.log(emp[0].textContent)
	console.log(emp[2].textContent)
	console.log(emp[4].textContent)
	console.log(emp[5].textContent)
...
function   getAnchorChildren() {
	var anchorChildren = document.querySelectorAll("a");
		for (i = 0; i < anchorChildren.length; i++) {
			var a = anchorChildren[i]
			var as = a.getElementsByTagName('span');
...
When   user   selects   a   skill,   create   an   alert   with   a   message   similar   to: "Are   you   sure   CSS   is   one   of   your   skills?"
