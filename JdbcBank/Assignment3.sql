...
(U_NAME IN VARCHAR2, PW IN VARCHAR2, FNAME IN VARCHAR2, LNAME IN VARCHAR2, ADM IN VARCHAR2, U_MADE OUT NUMBER)
IS
BEGIN
   INSERT INTO USERS (USERNAME,USER_PASS,FIRST_NAME,LAST_NAME,IS_ADMIN) VALUES(U_NAME,PW,FNAME,LNAME,ADM); 
   COMMIT;
END;
...
(U_ID IN NUMBER, A_ID IN NUMBER, PASS OUT NUMBER)
IS
BEGIN
...
CREATE OR REPLACE PROCEDURE INSERT_ACCOUNT (U_ID IN NUMBER)
IS
BEGIN
