...
public class BeehiveDaoImpl implements BeehiveDao{
	...
	public List<Beehive> getBeeHives() {
		...
		List<Beehive> bhl = new ArrayList<>();
	...
	public boolean updateBeehiveWeight(int id, int delta) {
		...
		try {
			...
			con.setAutoCommit(false); // manual text management
			String sql = "UPDATE BEEHIVE SET BEEHIVE WEIGHT =  BEEHIVE_WEIGHT+? WHERE BEEHIVE_ID = ?";
